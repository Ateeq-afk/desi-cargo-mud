...
export default function CustomerExport({ customers, onClose, onSuccess }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Export Customers</h2>
          <p className="text-gray-600 mt-1">Export {customers.length} customers to a file</p>
        </div>
        ...
        <>
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button 
              ...
              disabled={!Object.values(selectedFields).some(Boolean) || customers.length === 0}
      ...
      {step === 'exporting' && (
        <div className="py-12 flex flex-col items-center justify-center">
          ...
          <h3 className="text-lg font-medium text-gray-900">Exporting Customers</h3>
